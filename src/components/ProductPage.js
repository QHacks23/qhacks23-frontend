    ...
    return (
        <div className="product-page">
            ...
            <div className="product-info">
                ...
                {pageType === 'marketplace' ? <button className="buy-button" onClick={initBuyAsset}>Buy</button> : (
                    pageType === 'profile' ? <button className="buy-button" >You Own This</button> : (
                        pageType === 'buy' ? <button className="buy-button" >Pending</button> : (
                            pageType === 'sell' ? <button className="buy-button" onClick={initSellAsset}>Sell</button> : ( <button className="buy-button" onClick={initBuyAsset}>Buy</button>)
                        )))}
            </div>s
        </div>
    );
