...
import {buyAsset, createAsset} from "../client/Requests";
import auth from "../firebase";
import { useLocation } from "react-router-dom";
import { useNavigate } from "react-router-dom";
import axios from "axios";

function BuyMnemonic() {
    ...
    return (
        <div style={styles.container}>
            <div style={styles.inputContainer} onSubmit={onSubmit}>
                <h1 style={styles.mainHeader}>Are You Sure You Want To Buy This Asset?</h1>
                ...
                <button style={styles.submitButton} onClick={onSubmit}>
                    <h2 style={styles.singleHeader}>Buy Asset</h2>
                </button>
            </div>
        </div>
    );
